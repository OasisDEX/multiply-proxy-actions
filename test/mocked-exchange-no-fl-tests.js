...
describe("Multiply Proxy Action with Mocked Exchange", async function() {
  ...
  describe(`opening Multiply Vault`, async function() {
    ...
    it(`should open vault with required collateralisation ratio`, async function() {
      ...
      let params = prepareMultiplyParameters(MAINNET_ADRESSES.MCD_DAI, MAINNET_ADRESSES.ETH, exchangeDataMock, 0, desiredCdpState, multiplyProxyActions.address, exchange.address, address, true);
  ...
  describe(`Increasing Multiple`, async function() {
    ...
    it(`should increase vault's multiple to required collateralization ratio`, async function() {
      ...
      params = prepareMultiplyParameters(MAINNET_ADRESSES.MCD_DAI, MAINNET_ADRESSES.ETH, exchangeDataMock, CDP_ID, desiredCdpState, multiplyProxyActions.address, exchange.address, address, true);
