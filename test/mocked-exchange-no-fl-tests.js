...
describe("Multiply Proxy Action with Mocked Exchange", async function() {
  ...
  describe(`opening Multiply Vault`, async function() {
    ...
    it(`should open vault with required collateralisation ratio`, async function() {
      ...
      let params = prepareMultiplyParameters2(MAINNET_ADRESSES.MCD_DAI, MAINNET_ADRESSES.ETH, exchangeDataMock, 0, desiredCdpState, multiplyProxyActions.address, exchange.address, address, true);
      await dsproxyExecuteAction(multiplyProxyActions, dsProxy, address, 'openMultiplyVault', params, amountToWei(currentColl).toFixed(0));
  ...
  describe(`Increasing Multiple`, async function() {
    ...
    it(`should increase vault's multiple to required collateralization ratio`, async function() {
      ...
      let params = prepareMultiplyParameters2(MAINNET_ADRESSES.MCD_DAI, MAINNET_ADRESSES.ETH, exchangeDataMock, CDP_ID, desiredCdpState, multiplyProxyActions.address, exchange.address, address, true);
  ...
  describe(`Decrease Multiple`, async function() {
    ...
    it(`should decrease vault's multiple to required collateralization ratio`, async function() {
      ...
      let params = prepareMultiplyParameters2(MAINNET_ADRESSES.ETH, MAINNET_ADRESSES.MCD_DAI, exchangeDataMock, CDP_ID, desiredCdpState, multiplyProxyActions.address, exchange.address, address, true);
