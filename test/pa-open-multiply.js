...
describe("Proxy Action", async function () {
    ...
    this.beforeAll(async function () {
        ...
        let { mcdView, exchange, multiplyProxyActions, dsProxy, userProxyAddress } =
            await deploySystem(provider, primaryAddress);
        ...
        var check_1inch = async function (data) {
            ...
            data._1inchPayload = await exchangeFromDAI(
...
*/
            ...
            var openMultParameters = prepareMultiplyParameters(
            ...
            txResult = await dsproxyExecuteAction(
