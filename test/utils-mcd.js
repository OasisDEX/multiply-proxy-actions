...
const canGenerateDebt = async (ilkInfo) => {
  const vat = await hre.ethers.getContractAt('IVat', '0x35D1b3F3D7966A1DFe207aa4514C12a259A0492B')
...
const getVaultsForUser = async (user, makerAddresses) => {
  const GetCdps = await hre.ethers.getContractAt('IGetCdps', makerAddresses['GET_CDPS'])
