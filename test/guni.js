...
const GUNITokenLike = require('../abi/GUNITokenLike.json')
const UniPoolLike = require('../abi/UniPoolLike.json')
const GUNIResolverLike = require('../abi/GUNIResolverLike.json')
...
(async function () {
  ...
  const addressRegistry = addressRegistryFactory(multiplyProxyActions.address, exchange.address);
  ...
  console.log('LEV AMOUNT', leveragedAmount.toString());
  ...
  console.log('RESULT COLL RATIO', currentCollRatio.toFixed(2));
