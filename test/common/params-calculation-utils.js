...
const prepareMultiplyParameters = function (
    ...
    let cdpData = {
        ...
        depositCollateral: amountToWei(desiredCdpState.providedCollateral || zero, "ETH").toFixed(
            0
        ),
        withdrawDai: amountToWei(desiredCdpState.withdrawDai || zero, "ETH").toFixed(0),
        withdrawCollateral: amountToWei(desiredCdpState.withdrawCollateral || zero, "ETH").toFixed(
            0
        ),
    };
